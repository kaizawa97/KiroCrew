...
const CONVO_GRID =
  'grid items-center gap-2.5 grid-cols-[224px_minmax(0,1fr)_64px_40px_62px_48px_160px]'

function ConvoHeader() {
  return (
    <div
      className={`${CONVO_GRID} text-[10px] text-muted uppercase tracking-wide `
          ...
          <div className="card-glow border border-border bg-card rounded-xl p-3.5">
            ...
            <div className="flex flex-col gap-1.5">
              {c.conversations.map(v => (
                <div key={v.slot} className={`${CONVO_GRID} text-[11px]`}>
