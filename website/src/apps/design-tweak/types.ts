...
/**
 * What `POST /api/chat/slots` tells us about a slot: its recent transcript and
 * anything accepted but not yet processed. Used to verify that a sealed batch
 * actually reached the agent's session — see `delivery.ts`.
 */
