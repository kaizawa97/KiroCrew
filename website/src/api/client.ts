...
export const api = {
  ...
  // Grant trust for the config's CURRENT digest. Editing the file invalidates it.
  devcontainerTrust: (project: string) =>
    post('/api/devcontainer/trust', { project }).then(j) as Promise<{ trusted: boolean; digest: string }>,
